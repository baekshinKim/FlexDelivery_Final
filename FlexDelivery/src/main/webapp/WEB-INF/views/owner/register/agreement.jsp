...
<script type="text/javascript">
	$(function(){
		$('.btn').click(function(){
			if($(this).attr('name')=='cancle'){
				$(opener.document).find('input[type=checkbox]').prop('checked',false);
			}
			self.close();
		});
	});
...
<body>
	...
	<div style="margin:30px;">
		<small>안녕하세요 저희는 FLEX DELIVERY입니다
...
<br>
1. 수집하는 개인정보<br>
이용자는 회원가입을 하지 않아도 공지사항, 사장님꿀팁 등 대부분의 플렉스 딜리버리 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 내 점포, 1:1문의 등 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 플렉스 딜리버리는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 플렉스 딜리버리가 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br>
- 회원 가입 시에 ‘아이디, 비밀번호, 이름, 휴대전화번호’를 필수항목으로 수집합니다. 만약 이용자가 입력하는 생년월일이 만14세 미만 아동일 경우에는 가입하실 수 없습니다.<br>

서비스 이용 과정에서 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br>
플렉스 딜리버리 내의 개별 서비스 이용, 이벤트 및 정기 쿠폰 제공 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다.<br>
...
플렉스 딜리버리에서 제공하는 위치기반 서비스에 대해서는 '플렉스 딜리버리 위치정보 이용약관'에서 자세하게 규정하고 있습니다.<br>
이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.<br>
<br>
2. 수집한 개인정보의 이용<br>
플렉스 딜리버리 및 플렉스 딜리버리 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.<br>
...
- 법령 및 플렉스 딜리버리 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.<br>
- 유료 서비스 제공에 따르는 본인인증, 구매 및 요금 결제, 상품 및 서비스의 배달을 위하여 개인정보를 이용합니다.<br>
...
- 플렉스 딜리버리 플러스 멤버십 서비스 혜택 중복 제공 방지<br>
암호화처리(해시처리)한DI :혜택 제공 종료일로부터6개월 보관<br>
전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. 플렉스 딜리버리는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.<br>
...
참고로 플렉스 딜리버리는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.<br>
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.<br>
	...
	<div style="text-align: center; margin-top:30px;">
		<button class="btn" name="agree" style="width: 50px;height:50px;">동의</button>
		<button class="btn" name="cancle"  style="width: 50px;height:50px;">취소</button>
